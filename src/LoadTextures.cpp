...
{
    std::cout << "Load texture BMP: " << image_path << std::endl;

    int width, height, nrChannel;
    unsigned char *data = stbi_load(image_path, &width, &height, &nrChannel, 0);
    if (!data)
    {
...
{
    std::cout << "Load texture DDS: " << image_path << std::endl;
