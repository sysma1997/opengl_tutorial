...
void vectors()
{
    ...
    std::cout << "Vector1: " << glm::to_string(vector1) << '\n';
    std::cout << "Vector2: " << glm::to_string(vector2) << '\n';
    std::cout << '\n';
    std::cout << "Sum:                " << glm::to_string(sum(vector1, vector2)) << '\n';
    std::cout << "Difference:         " << glm::to_string(difference(vector1, vector2)) << '\n';
    std::cout << "Scale:              " << glm::to_string(scale(vector1, vector2)) << '\n';
    std::cout << "Unit/Normalization: " << glm::to_string(unit(vec2(-1, -7))) << '\n';
}